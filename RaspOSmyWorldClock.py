...
class AnalogClockApp:
    def __init__(self, root):
        ...
        #self.txtWdgDoW.tag_configure("Hangul", justify="center", font=("Batang", 28, "bold"))
        ...
        #self.txtWdgSeoul.tag_configure("Hangul", justify="center", font=("Batang", 32, "bold"))
    ...
    def update_clock(self):
        ...
        if now.second == 0:
            self.root.geometry(f"+{now.minute*18}+28")    # move Window every minutes
